...
public class Command {
	 ...
	 *
	 * @param connection
	 *            ClientConnection object to be used for sending packets to the
	 *            Shard
	 */
	 ...
	 *
	 * @throws SendPacketException
	 *             thrown if there is an error sending the packet to the Shard.
	 *             Details will be in the getMessage()
	 */
	 ...
	 *
	 * @param s
	 *            string being sent to the Shard
	 * @throws SendPacketException
	 *             thrown if there is an issue sending the packet to the Shard.
	 *             Details will be in the getMessage()
	 */
	 ...
	 *
	 * @param kelvin
	 *            double value of temperature in kelvin
	 ...
	 *
	 * @param a
	 *            int value of the Calendar month
